  ...
  return (
    <html lang="en">
      <body className="bg-black text-white">
        {/* --- Simple header (replace with your real Header component if you have one) --- */}
        ...
        {/* --- This is CRITICAL: render the current page here --- */}
        {children}

        {/* --- Optional simple footer placeholder --- */}
        <footer className="border-t border-white/10">
          <div className="container py-6 text-sm text-white/70">
            © {new Date().getFullYear()} Traffik.nz • Christchurch, NZ
          </div>
        </footer>
        ...
        <Script id="schema-profservice" type="application/ld+json" strategy="afterInteractive">
          {JSON.stringify({
            ...
            hasOfferCatalog: {
              ...
              itemListElement: [
                { '@type': 'Offer', name: 'AI Website Audit', priceCurrency:
