...
export default function RootLayout({ children }: { children: ReactNode }) {
  // Single, linked JSON-LD graph (Organization + MarketingAgency + WebSite)
  const jsonLd = {
    ...
    '@graph': [
      {
        ...
        name: 'Traffik',
        url: 'https://traffik.nz/',
        // Use a real, accessible image path:
        logo: 'https://traffik.nz/logo.png',
        sameAs: [], // add LinkedIn/Facebook later
        contactPoint: [
          {
            '@type': 'ContactPoint',
  ...
  return (
    <html lang="en">
      <head>
        {/* JSON-LD in <head> so parsers see it immediately */}
        <Script
          id="schema-graph"
